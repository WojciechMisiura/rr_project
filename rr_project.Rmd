...
packages <- c("readr", "dplyr", "ggplot2", "lubridate", "zoo", "scales", "cowplot", "patchwork", "plm", "lmtest")
...
```
As p-value is effectively zero, we reject the null hypothesis of the test. This suggests that there is evidence of random effects in our data. Reandom effects model may be more appropriate than a simple pooled OLS model.
